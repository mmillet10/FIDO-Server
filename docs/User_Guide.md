...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"attestation":  |  [**"none"**, "indirect", "direct"]<br><br>"none": Attestation statement does not matter to the RP web application.<br>"direct": RP web application uses attestation from the Authenticator.<br>
"indirect": Client determines attestation statement; source may vary.
